...
const PropertyDetails = () => {
  ...
  const handleTimeChange = (event) => {
    ...
    if (
      ...
      (selectedHours < new Date().getHours() || 
        (selectedHours === new Date().getHours() && selectedMinutes <= new Date().getMinutes()))
    ) {
      alert('You cannot select a time in the past.');
    } else {
      setAppointmentTime(selectedTime);
  ...
  return (
    <div className="p-6 max-w-6xl mx-auto">
      ...
      <div className="flex flex-col lg:flex-row gap-6 mt-6">
        ...
        <div className="flex-1">
          ...
          <div className="mt-4">
            ...
            <p>
              <strong>Property For:</strong> {property.type}
            </p>
            <p>
      ...
      {/* Conditionally Render Booking Section */}
      {property.seller && property.seller._id === userId ? (
